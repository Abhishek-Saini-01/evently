...
import { createEvent, updateEvent } from "@/db/actions/Event.action"
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
                <div className="flex flex-col gap-5 md:flex-row">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                <FormControl>
                                    <Dropdown onChangeHnadler={field.onChange} value={field.value} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                ...
                >{
                    form.formState.isSubmitting ? <Loader2 className="h-8 w-8 animate-spin" /> : `${type} Event`
                }</Button>
